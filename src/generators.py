...
def card_number_generator(start, stop):
    """функция генерирования номера карты в формате XXXX XXXX XXXX XXXX"""

    for i in range(start, stop + 1):
        new_card_number = str(i).zfill(16)
        formated_card_number = (
            f"{new_card_number[:4]} {new_card_number[4:8]} {new_card_number[8:12]} {new_card_number[12:]}"
        )
